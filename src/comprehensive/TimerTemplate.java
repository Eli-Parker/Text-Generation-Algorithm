...
/**
 * Abstract class which can be used as a skeleton for performing timing tests
...
abstract public class TimerTemplate {
    ...
    private final int[] problemSizes; //what N's should we time?
    private final int timesToLoop; //average the result of many trials
